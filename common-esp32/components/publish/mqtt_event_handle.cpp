...
mqtt_event_handle& mqtt_event_handle::operator=(mqtt_event_handle&& o) noexcept
{
...
mqtt_event_handle mqtt_register_event(
	esp_mqtt_client_handle_t client,
	esp_mqtt_event_id_t event, void* arg,
	esp_event_handler_t event_handler)
{
	check(esp_mqtt_client_register_event(client, event, event_handler, arg), "register MQTT event");
