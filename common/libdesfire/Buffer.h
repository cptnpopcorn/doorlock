...
public:
    ...
    uint16_t ReadUint16()
    {
        ...
        uint16_t u16_Data;
        std::memcpy(&u16_Data, mu8_Buf + ms32_Pos, 2);
        ms32_Pos += 2;
        return u16_Data;
    }
    ...
    uint32_t ReadUint24()
    {
        ...
        uint32_t u32_Data = 0;
        std::memcpy(&u32_Data, mu8_Buf + ms32_Pos, 3); // Copy only the lower 3 bytes
        ms32_Pos += 3;
        return u32_Data;
    }
    ...
    uint32_t ReadUint32()
    {
        ...
        uint32_t u32_Data;
        std::memcpy(&u32_Data, mu8_Buf + ms32_Pos, 4);
        ms32_Pos += 4;
        return u32_Data;
    }
    ...
    bool ReadBuf(uint8_t* u8_Buffer, int s32_Count)
    {
        ...
        std::memcpy(u8_Buffer, mu8_Buf + ms32_Pos, s32_Count);
        ms32_Pos += s32_Count;
        return true;
    }
...
public:
    ...
    bool AppendBuf(const uint8_t* u8_Data, int s32_Count)
    {
        ...
        std::memcpy(mu8_Buf + ms32_Pos, u8_Data, s32_Count);
        ms32_Pos += s32_Count;
        return true;
    }
    ...
    bool AppendUint16(uint16_t u16_Data)
    {
        ...
        std::memcpy(mu8_Buf + ms32_Pos, &u16_Data, 2);
        ms32_Pos += 2;
        return true;
    }
    ...
    bool AppendUint24(uint32_t u32_Data)
    {
        ...
        std::memcpy(mu8_Buf + ms32_Pos, &u32_Data, 3);
        ms32_Pos += 3;
        return true;
    }
    ...
    bool AppendUint32(uint32_t u32_Data)
    {
        ...
        std::memcpy(mu8_Buf + ms32_Pos, &u32_Data, 4);
        ms32_Pos += 4;
        return true;
    }
