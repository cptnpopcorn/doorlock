...
class Desfire : public PN532
{
 public:
    ...
    bool CreateStdDataFile(uint8_t u8_FileID, DESFireFilePermissions* pk_Permis, int s32_FileSize);
    bool ReadFileData     (uint8_t u8_FileID, int s32_Offset, int s32_Length, uint8_t* u8_DataBuffer);
    bool WriteFileData    (uint8_t u8_FileID, int s32_Offset, int s32_Length, const uint8_t* u8_DataBuffer);
